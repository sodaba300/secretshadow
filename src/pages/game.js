...
const BG_KEY = 'bg'
const BG_PATH = '/asset/bg.webp'
const TITLE_KEY = 'title'
const TITLE_PATH = '/asset/title.webp'
const TITLE_X = 122
const TITLE_Y = 85
const TITLE_DEPTH = 82
const SCORE_BG_KEY = 'scoreBg'
const SCORE_BG_PATH = '/asset/scoreBg.webp'
...
const COIN_KEY = 'coin'
const COIN_ATLAS_PATH = '/asset/coin.png'
const COIN_JSON_PATH = '/asset/coin.json'
...
const COIN_VISIBLE_SFX_PATH = '/asset/coin_visible.mp3'
const COIN_COLLECT_SFX_KEY = 'coinCollectSfx'
const COIN_COLLECT_SFX_PATH = '/asset/coin_collect.mp3'
const CLOUD_PATH = '/asset/cloud.webp'
...
const HINT_PANEL_PATH = '/asset/hintPannel.webp'
...
const HINT_PANEL_SFX_PATH = '/asset/hintPannel.mp3'
...
const WORDS_PATH = '/data/word.json'
...
const CLOCK_BG_PATH = '/asset/clockBg.webp'
...
const STAR_KEY = 'star'
const STAR_PATH = '/asset/star.webp'
const MIC_ACTIVE_KEY = 'micActive'
const MIC_ACTIVE_ATLAS_PATH = '/asset/micActive.webp'
const MIC_ACTIVE_JSON_PATH = '/asset/micActive.json'
...
const MYSTERY_BGM_PATH = '/asset/mystery.mp3'
const SMALL_EXPLOSION_SFX_KEY = 'smallExplosionSfx'
const SMALL_EXPLOSION_SFX_PATH = '/asset/small_explosion.mp3'
const MIC_ACTIVE_VIS_SFX_KEY = 'micActiveVisSfx'
const MIC_ACTIVE_VIS_SFX_PATH = '/asset/micActive_vis.mp3'
const BEAM_SFX_KEY = 'beamSfx'
const BEAM_SFX_PATH = '/asset/beam.mp3'
const INCORRECT_SFX_KEY = 'incorrectSfx'
const INCORRECT_SFX_PATH = '/asset/incorrect.mp3'
const CORRECT_SFX_KEY = 'correctSfx'
const CORRECT_SFX_PATH = '/asset/correct.mp3'
const QUIZ_EXPLOSION_SFX_KEY = 'quizExplosionSfx'
const QUIZ_EXPLOSION_SFX_PATH = '/asset/quizExplosion.mp3'
...
const BLOCK_PATH = '/asset/block.webp'
...
const BIG_STAR_PATH = '/asset/bigStar.webp'
...
const SUCCESS_IMAGE_PATH = '/asset/success.webp'
...
const RE_BTN_PATH = '/asset/reBtn.webp'
const NE_BTN_KEY = 'neBtn'
const NE_BTN_PATH = '/asset/neBtn.webp'
const RE_BTN_X = 513
const RE_BTN_Y = 673
const NE_BTN_X = 816
const NE_BTN_Y = 673
